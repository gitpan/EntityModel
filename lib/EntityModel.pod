...
L<add_entity|EntityModel::Model/add_entity>, L<add_field_to_table|EntityModel::Model/add_field_to_table>, L<add_table|EntityModel::Model/add_table>, L<apply|EntityModel::Model/apply>, L<apply_fields|EntityModel::Model/apply_fields>, L<commit|EntityModel::Model/commit>, L<commit_pending_add|EntityModel::Model/commit_pending_add>, L<commit_pending_remove|EntityModel::Model/commit_pending_remove>, L<commit_pending_update|EntityModel::Model/commit_pending_update>, L<create_entity|EntityModel::Model/create_entity>, L<create_table|EntityModel::Model/create_table>, L<dump|EntityModel::Model/dump>, L<entity_by_name|EntityModel::Model/entity_by_name>, L<flush|EntityModel::Model/flush>, L<handle_item|EntityModel::Model/handle_item>, L<hasPending|EntityModel::Model/hasPending>, L<load_model|EntityModel::Model/load_model>, L<matches|EntityModel::Model/matches>, L<new_entity|EntityModel::Model/new_entity>, L<pending|EntityModel::Model/pending>, L<pending_entities|EntityModel::Model/pending_entities>, L<provide_handler_for|EntityModel::Model/provide_handler_for>, L<read_tables|EntityModel::Model/read_tables>, L<remove_entity|EntityModel::Model/remove_entity>, L<remove_table|EntityModel::Model/remove_table>, L<resolve_entity_dependencies|EntityModel::Model/resolve_entity_dependencies>, L<rollback|EntityModel::Model/rollback>, L<table|EntityModel::Model/table>, L<update_from|EntityModel::Model/update_from>, L<update_table|EntityModel::Model/update_table>
